...
export default function UploadButton({ onFileSelect, width, loading, text, allowedTypes }: UploadButtonProps) {
  ...
  return (
    <>
      <label 
        htmlFor="file-upload"
        className="inline-flex justify-center items-center gap-x-3 text-center bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 border border-transparent text-white text-md font-medium rounded-[100] focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500 cursor-pointer py-2 px-4 transition-all duration-300 ease-in-out min-w-[150px]"
